...
import { GET_ELECTION_ERROR, GET_ELECTION_PROGRESS, GET_ELECTION_SUCCESS, POST_ELECTION_ERROR, POST_ELECTION_PROGRESS, POST_ELECTION_SUCCESS } from "./ElectionAction";
    ...
    switch (action.type) {
        ...
        case POST_ELECTION_SUCCESS: {
            return {
                ...state,
                isLoading: false,
                data: state.data.concat(action.detail),
                isError: null
            }
        }
