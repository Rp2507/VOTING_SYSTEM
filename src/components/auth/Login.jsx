                    ...
                    <div>
                        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                            <img
                                ...
                                src={loginImage}
                                alt="login image" /> <h3 className='text-center font-semibold text-gray-900 '>E-ELECTION</h3>
                            ...
                            <div className='space-y-6'>
                                ...
                                <div>
                                    <button
                                        ...
                                        className="flex w-full justify-center rounded-md  px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 bg-gray-950 "
                                    >
                                        Sign In
                                    </button>
                                </div>
